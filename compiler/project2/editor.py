...
from compiler.project2.main import compile


class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Eshkene lang editor")
        # self.geometry()
    ...
    def compile(self):
        ...
        try:
            ...
            # print(self.current_directory ,output_path+".eshk")
            self.create_top(output_path ,"hi")
    ...
    def open(self):
        ...
        self.current_directory = filedialog.askopenfilename(title="Select file" ,filetypes=(("text files","*.txt") ,("all files","*.*")))
        self.title("Eshkene lang editor"+"--"+self.current_directory)
        code = ""
    ...
    def create_top(self ,output_path ,compiled_code):
        top = tk.Toplevel(self)
        top.title("Eshkene lang editor--"+output_path+".eshk")
